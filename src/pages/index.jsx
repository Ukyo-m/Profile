            ...
            <div className="career-right">
              ...
              <table className="career-table">
                <tbody><tr>
                  ...
                  <td className="career-detail">栃木県立那須拓陽高等学校 普通科 卒業</td>
                </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="career-detail">全研本社株式会社(アルバイト) イノベーション事業部 コーダーとして従事</td>
                  </tr>
                  <tr>
                    <th className="career-date">2020年1月</th>
                    <td className="career-detail">全研本社株式会社 コミュニケーションプロダクツ事業部 プログラマーとして従事</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="career-detail">HAL東京 高度情報処理学科 3年次在学</td>
                  </tr>
                </tbody></table>
            </div>
          </div>
